...
#     resi_3 = tf.add(relud_1, convd_3)
#     relud_3 = tf.nn.relu(resi_3)
...
#     resi_4 = tf.add(relud_1, convd_4)
#     relud_4 = tf.nn.relu(resi_4)
...
#     resi_5 = tf.add(relud_3, convd_5)
#     relud_5 = tf.nn.relu(resi_5)
    
#     relud_concat = tf.concat([relud_3, relud_5], axis=3, name='relud_concat')
...
#     bd_7 = utils.bias_variable([NUM_OF_CLASSESS], name="bd_7")
#     convd_7 = utils.conv2d_dilated(relud_5, Wd_7, bd_7, rate=1)
#     relud_7 = tf.nn.relu(convd_7, name='relud_7')
    
#     Wd_8 = utils.weight_variable_cconv([3, 3, NUM_OF_CLASSESS, NUM_OF_CLASSESS], name="Wd_8")
#     bd_8 = utils.bias_variable([NUM_OF_CLASSESS], name="bd_8")
#     convd_8 = utils.conv2d_dilated(relud_7, Wd_8, bd_8, rate=1)
# #     relud_8 = tf.nn.relu(convd_8, name='relud_8')
    
#     resi_8 = tf.add(relud_5, convd_8)
#     relud_8 = tf.nn.relu(resi_8)
    
#     Wd_9 = utils.weight_variable_cconv([1, 1, NUM_OF_CLASSESS, NUM_OF_CLASSESS], name="Wd_9")
#     bd_9 = utils.bias_variable([NUM_OF_CLASSESS], name="bd_9")
#     convd_9 = utils.conv2d_dilated(relud_8, Wd_9, bd_9, rate=1)
...
#         conv_t3 = utils.conv2d_transpose_strided(conv8, W_t, b_t, output_shape=deconv_shape, stride=8)
#     else:
#         conv_t3 = utils.conv2d_transpose_strided(convd_9, W_t, b_t, output_shape=deconv_shape, stride=8)
